    ...
    boundProps.forEach(function (boundProp) {
        ...
        switch (boundProp.type) {
            ...
            case template_ast_1.PropertyBindingType.Animation:
                ...
                updateStmts.push(o.THIS_EXPR.callMethod('registerActiveAnimation', [o.literal(animationName), PLAYER_VAR]).toStmt());
                updateStmts.push(PLAYER_VAR.callMethod('onDone', [
                    o.fn([], [
                        o.THIS_EXPR.callMethod('registerActiveAnimation', [o.literal(animationName), o.NULL_EXPR]).toStmt()
                    ])
                ]).toStmt());
